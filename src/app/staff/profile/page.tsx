...
/**
 * Staff profile — leaner than depositor profile. Emphasizes role and
 * checkpoint assignment over personal stats.
 */
export default function StaffProfilePage() {
  return (
    <MobileShell>
      ...
      <PageBody>
        <section
          className="surface-card p-6 flex flex-col items-center text-center gap-4"
          style={{
            background:
              "radial-gradient(140% 80% at 50% 0%, rgba(182,127,75,0.18) 0%, transparent 50%), rgba(22,27,34,0.85)",
          }}
        >
          ...
          <div>
            ...
            <h1 className="text-h2 font-display text-white mt-1">{staffUser.name}</h1>
            <p className="text-small text-gray-400">{staffUser.email}</p>
          </div>
